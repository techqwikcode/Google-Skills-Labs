...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Host%20a%20Web%20App%20on%20Google%20Cloud%20Using%20Compute%20Engine%20-%20Azure/GSP1123.sh
sudo chmod +x GSP1123.sh 
./GSP1123.sh
```

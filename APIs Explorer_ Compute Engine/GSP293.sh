...
echo "${CYAN}${BOLD}"
echo "**********************************************************************"
echo "* Welcome to Tech Qwik Code Cloud Tutorial!                            *"
echo "*                                                                    *"
echo "* Please do like, share and subscribe to the channel:                *"
echo "* https://www.youtube.com/@techqwikcode/videos                    *"
echo "*                                                                    *"
...
echo "*                                                                    *"
echo "* Don't forget to subscribe to Tech Qwik Code YouTube channel:       *"
echo "* https://www.youtube.com/@techqwikcode/videos                    *"
echo "*                                                                    *"

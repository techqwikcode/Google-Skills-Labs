# 🌐 App Engine: Qwik Start - PHP || GSP069 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7010/labs/43584)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/App%20Engine_%20%20Qwik%20Start%20-%20PHP/GSP069.sh
chmod +x GSP069.sh 
./GSP069.sh
```

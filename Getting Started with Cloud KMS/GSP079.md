# 🌐 Getting Started with Cloud KMS || GSP079 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7012/labs/43605)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Getting%20Started%20with%20Cloud%20KMS/GSP079.sh
chmod +x GSP079.sh 
./GSP079.sh
```

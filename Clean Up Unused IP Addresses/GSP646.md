# 🌐 Clean Up Unused IP Addresses || GSP097 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7028/labs/43718)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Clean%20Up%20Unused%20IP%20Addresses/GSP646.sh
chmod +x GSP646.sh 
./GSP646.sh
```

# 🌐 APIs Explorer: App Engine || GSP422 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7007/labs/43540)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/APIs%20Explorer_%20App%20Engine/GSP422.sh
chmod +x GSP422.sh 
./GSP422.sh
```

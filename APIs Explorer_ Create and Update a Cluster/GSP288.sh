...
echo "${CYAN}${BOLD}   TECH QWIK CODE DATAPROC DEPLOYMENT LAB   ${RESET}"
echo "${CYAN}${BOLD}============================================${RESET}"
echo "${BLUE}YouTube Channel: https://www.youtube.com/@techqwikcode${RESET}"
echo "${CYAN}Video Tutorials: https://www.youtube.com/@techqwikcode/videos${RESET}"
echo
...
echo "${CYAN}Subscribe totechqwikcode YouTube Channel:${RESET}"
echo "${YELLOW}https://www.youtube.com/@techqwikcode${RESET}"
echo "${CYAN}Video Tutorials:${RESET}"
echo "${YELLOW}https://www.youtube.com/@techqwikcode/videos${RESET}"
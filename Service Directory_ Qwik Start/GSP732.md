# 🌐 Service Directory: Qwik Start || GSP732 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7027/labs/43690)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Service%20Directory_%20Qwik%20Start/GSP732.sh
chmod +x GSP732.sh 
./GSP732.sh
```

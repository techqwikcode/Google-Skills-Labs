...
echo "${CYAN}${BOLD}   TECH QWIK CODE    ${RESET}"
echo "${CYAN}${BOLD}============================================${RESET}"
echo "${BLUE}YouTube Channel: https://www.youtube.com/@techqwikcode${RESET}"
echo "${MAGENTA}Video Tutorials: https://www.youtube.com/@techqwikcode/videos${RESET}"
echo
...
echo "${BLUE}Subscribe to Tech Qwik Code YouTube Channel:${RESET}"
echo "${WHITE}https://www.youtube.com/@techqwikcode${RESET}"
echo "${BLUE}Video Tutorials:${RESET}"
echo "${WHITE}https://www.youtube.com/@techqwikcode/videos${RESET}"
# 🌐 Cloud DNS: Traffic Steering using Geolocation Policy || GSP1008 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/course_templates/744/labs/582693)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Cloud%20DNS_%20Traffic%20Steering%20using%20Geolocation%20Policy/GSP1008.sh
chmod +x GSP1008.sh 
./GSP1008.sh
```

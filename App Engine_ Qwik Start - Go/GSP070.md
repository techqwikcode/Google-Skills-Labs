# 🌐 App Engine: Qwik Start - Go || GSP070 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7010/labs/43584)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/App%20Engine_%20Qwik%20Start%20-%20Go/GSP070.sh
chmod +x GSP070.sh 
./GSP070.sh
```

# 🌐 Cloud IAM: Qwik Start || GSP064 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7010/labs/43584)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Cloud%20IAM_%20Qwik%20Start%20/GSP064.sh
chmod +x GSP064.sh 
./GSP064.sh
```

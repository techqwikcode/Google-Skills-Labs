...
echo "${CYAN_TEXT}${BOLD_TEXT}🚀  WELCOME TO TECH QWIK CODE CLOUD TUTORIALS  🚀${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}============================================${RESET_FORMAT}"
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Don't forget to subscribe to Tech Qwik Code YouTube channel:${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@techqwikcode/videos${RESET_FORMAT}"
echo
echo "${CYAN_TEXT}${BOLD_TEXT}===================================${RESET_FORMAT}"
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Thank you for following Tech Qwik Code Cloud Tutorials!${RESET_FORMAT}"

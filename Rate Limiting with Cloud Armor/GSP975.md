# 🌐 Rate Limiting with Cloud Armor || GSP975 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7027/labs/43694)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Rate%20Limiting%20with%20Cloud%20Armor/GSP975.sh
chmod +x GSP975.sh 
./GSP975.sh
```

# 🌐 Orchestrating the Cloud with Kubernetes || GSP021 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7014/labs/43616)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Orchestrating%20the%20Cloud%20with%20Kubernetes/GSP021.sh
chmod +x GSP021.sh 
./GSP021.sh
```

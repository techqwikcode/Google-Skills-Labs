# 🌐 Video Intelligence: Qwik Start || GSP154 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7007/labs/43539)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Video%20Intelligence_%20Qwik%20Start/GSP154.sh
chmod +x GSP154.sh 
./GSP154.sh
```

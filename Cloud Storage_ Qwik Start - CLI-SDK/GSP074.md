# 🌐 Cloud Storage: Qwik Start - CLI/SDK || GSP074 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7010/labs/43584)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Cloud%20Storage_%20Qwik%20Start%20-%20CLI-SDK/GSP074.sh
chmod +x GSP074.sh 
./GSP074.sh
```

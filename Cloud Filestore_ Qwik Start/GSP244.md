# 🌐 Cloud Filestore: Qwik Start || GSP244 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.skills.google/games/7027/labs/43698)
...
```bash
curl -LO raw.githubusercontent.com/techqwikcode/Google-Skills-Labs/main/Cloud%20Filestore_%20Qwik%20Start/GSP244.sh
chmod +x GSP244.sh 
./GSP244.sh
```
